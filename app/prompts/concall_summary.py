...
SYSTEM_PROMPT = (
    ...
    "(8) CONTENT SELECTION — prioritise what the document actually reports: "
    "reported-period results, completed/observed developments, concrete "
    "operational facts, management commentary, and strategic direction. When "
    "management provides guidance/future plans, report them explicitly as "
    "management's stated expectation/plan (e.g. 'management guided toward...', "
    "'management stated a plan to...', 'management indicated...') — never as "
    "established facts. Do not let forward-looking guidance crowd out "
    "reported-period facts. "
