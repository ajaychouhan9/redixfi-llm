...
| Cases | 20 of 20 |
| Run id | `20260829T135557Z` (2026-08-29T13:55:57.949322+00:00) |
...
| unguided | 0 |
| mean_latency_sec | 58.539 |
| total_prompt_tokens | 300752 |
| total_completion_tokens | 9897 |
| quality_verdict | NOT COMPUTED — requires human review, by design |
| tone_label_agreement_rate | 0.7059 |
| invalid_tone_labels | 0 |
| tone_confusion | Mixed->Neutral=2, Positive->Positive=7, Neutral->Neutral=4, Mixed->None=2, Mixed->Mixed=1, Positive->Mixed=2, Mixed->Positive=1, Positive->None=1 |
| mean_lexical_overlap | 0.2575 |
...
Kanpur Plastipack Limited (KANPRPLA) presented its financial results for Q4 FY26, highlighting growth in total income, EBITDA, and net profit compared to previous periods. The company reported a 7.26% year-over-year (Y-o-Y) increase in total income to ₹18,505 lakh, with EBITDA rising by 20.67% to ₹2,556 lakh and net profit growing by 24.70% to ₹1,492 lakh. For the full year, total income grew by 26.98% to ₹73,132 lakh, EBITDA increased by 42.11% to ₹7,770 lakh, and net profit rose by 76.39% to ₹4,080 lakh. The company emphasized its integrated manufacturing model, global presence in over 60 countries, and strategic initiatives such as capacity expansion, sustainability efforts, and diversification into premium products like high-performance PP yarn and non-woven fabrics. Key milestones included the acquisition of Valex Ventures Ltd (UK) and a joint venture with Essegomma S.p.A. (Italy). The presentation also outlined plans for new facilities, including a non-woven production unit set to commence in September 2026 and a new warehouse at Unit 3, with construction nearing completion. The company noted a shift in product mix toward higher-margin offerings and continued focus on renewable energy and cost optimization.

**tone_note**

The document emphasizes growth in financial metrics, strategic expansions, and positive developments in product diversification and sustainability.
...
| tone_label valid (closed set) | ✅ |
| tone_label agrees | ✅ yes |
| Lexical overlap | 0.2803 _(triage aid, NOT a score)_ |
| Output shape | ✅ guided decoding — valid JSON by construction |
| Structured mode | `json_schema` |
| Latency | 26.8919 s |
| Input / output tokens | 5765 / 361 |
...
TVS Electronics Limited's Q4-FY26 earnings presentation highlights revenue growth across its segments. The Products and Solutions Group (PSG) reported revenue of INR 804 Mn in Q4-FY26, a 2.3% increase from Q3-FY26 and 3.0% year-over-year (Y-o-Y) growth for FY26. Customer Support Services (CSS) revenue rose to INR 370 Mn in Q4-FY26, a 5.7% increase from Q3-FY26 and 12.7% Y-o-Y growth for FY26. Overall revenue for Q4-FY26 was INR 1,174 Mn, up 3.3% Q-o-Q and 2.4% Y-o-Y, with FY26 revenue at INR 4,552 Mn, a 5.7% Y-o-Y increase. EBITDA for Q4-FY26 was INR 70 Mn, with a margin of 5.96%, up 24 basis points (Bps) Q-o-Q and 413 Bps Y-o-Y. FY26 EBITDA was INR 195 Mn, with a margin of 4.28%, up 172 Bps from FY25. The company noted improved margins due to better product mix and TCM initiatives. The balance sheet showed total liabilities of INR 1,866 Mn as of FY26, with equity at INR 959 Mn. The stock price as of March 31, 2026, was INR 360.5, with a market cap of INR 6,723.4 Mn. The presentation included forward-looking statements with disclaimers about risks and uncertainties.
...
| tone_label valid (closed set) | ✅ |
| tone_label agrees | ✅ yes |
| Lexical overlap | 0.2241 _(triage aid, NOT a score)_ |
| Output shape | ✅ guided decoding — valid JSON by construction |
| Structured mode | `json_schema` |
| Latency | 31.5018 s |
| Input / output tokens | 6192 / 430 |
| Tokens/sec (output) | 13.7 |
...
The investor presentation for Q4 FY2025-26 by Sigachi Industries Limited outlines operational and financial highlights, emphasizing strategic growth initiatives and competitive advantages. Management highlighted the Dahej-2 capacity expansion, progressing on schedule to elevate total MCC capacity to 30,000 MTPA. The new API R&D Center in Hyderabad is fully operational, with ongoing CEP filing pipeline development. Financials show revenue of Rs. 1,219 Mn, EBITDA of Rs. 154 Mn, and PAT of Rs. 76 Mn for Q4 FY26. The presentation noted a 4.01% QoQ revenue increase and a 170.17% QoQ rise in EBITDA. Guidance for FY27 includes management's plans for revenue of Rs. 6,500–6,750 Mn, 18–20% EBITDA margin, and >65% capacity utilization post-Dahej-2 ramp-up. The document also outlines historical financials, balance sheet details, and key milestones, including the company's listing on NSE and BSE in 2021 and expansion to 21,000 MTPA in 2023. The presentation includes a disclaimer about forward-looking statements and risks associated with future performance.

**tone_note**

The document presents both positive growth initiatives and cautionary notes about forward-looking statements and risks.
...
| tone_label valid (closed set) | ✅ |
| tone_label agrees | ✅ yes |
| Lexical overlap | 0.3077 _(triage aid, NOT a score)_ |
| Output shape | ✅ guided decoding — valid JSON by construction |
| Structured mode | `json_schema` |
| Latency | 50.441 s |
| Input / output tokens | 15159 / 703 |
...
| Structured mode | `json_schema` |
| Latency | 97.0473 s |
| Input / output tokens | 34479 / 1010 |
...
The investor presentation for Punjab National Bank (PNB) for Q1 FY2027 highlights strong financial performance, with net profit rising 213.6% YoY to ₹5,253 crore, driven by a 67 bps increase in ROA to 1.04% and a 17.2% YoY rise in operating profit. Business growth was robust, with global business up 10.2% YoY and domestic deposits growing 8.5% YoY. Asset quality improved, with GNPA down 100 bps YoY to 0.28% and net NPA at 0.28%. Capital adequacy remained strong, with CRAR at 18.13%. Digital initiatives showed progress, including 365 lakh PNB One activated users and 357 crore digital transactions. The presentation also outlined guidance for FY2027, including credit growth of 12-13% and deposit growth of 9-10%, though actuals for June 2026 showed deposit growth at 8.5%. ESG efforts included green financing initiatives and awards for sustainability. The tone of the document emphasizes positive financial metrics and strategic growth areas, while acknowledging challenges like global headwinds and inflationary pressures.

**tone_note**

The document emphasizes positive financial results and strategic initiatives but also acknowledges external challenges and some underperformance relative to guidance.
...
| tone_label valid (closed set) | ✅ |
| tone_label agrees | ❌ no |
| Lexical overlap | 0.2835 _(triage aid, NOT a score)_ |
| Output shape | ✅ guided decoding — valid JSON by construction |
| Structured mode | `json_schema` |
| Latency | 193.1379 s |
| Input / output tokens | 42112 / 722 |
...
The investor presentation for Vedant Fashions Limited (MANYAVAR) outlines the company's financial performance and strategic initiatives for Q1 FY27. The company reported a 3.4% year-over-year growth in retail sales and a 3.8% increase in domestic same-store sales growth (SSSG). Revenue from operations rose by 7.2%, while gross margin remained strong at 65.7%. Profit after tax (PAT) grew by 14.7% with a margin of 26.7%. The presentation highlights the company's extensive retail presence, including 501 domestic exclusive brand outlets (EBOs) across 205 cities, and its diversified brand portfolio, including Manyavar, Mohey, Twamev, and Diwas. The company emphasized its unique business model, technology-driven supply chain, and marketing strategies. It also provided a historical overview of key milestones, such as brand launches, market expansions, and awards. The document noted the company's long-term growth trajectory, with consistent revenue and profit growth over the past few fiscal years. The presentation concluded with a glossary of key terms and contact information for investor relations.

**tone_note**

The document emphasizes growth metrics, strong financial performance, and strategic advantages.
...
| tone_label valid (closed set) | ✅ |
| tone_label agrees | ✅ yes |
| Lexical overlap | 0.3529 _(triage aid, NOT a score)_ |
| Output shape | ✅ guided decoding — valid JSON by construction |
| Structured mode | `json_schema` |
| Latency | 46.5928 s |
| Input / output tokens | 14880 / 627 |
...
Go Fashion (India) Limited's Q1 FY27 investor presentation highlights a 2% YoY revenue growth to Rs. 161 crores, with gross profit rising 2% to Rs. 50 crores and a 4% increase in profit after tax to Rs. 8 crores. However, online revenue remained flat at Rs. 140 crores, while a 54% YoY decline in MBO & others revenue was reported. The company closed 66 stores during the quarter, reducing retail space by 7,016 sq. ft. and contributing to a 6.5 crore exceptional expense. Despite this, working capital days improved slightly, and cash flow from operations stood at Rs. 25.4 crores. The presentation noted a 14.0% EBITDA margin (before exceptional items) in Q1 FY27, down from 15.9% in Q1 FY26, attributed to increased marketing spend. The company emphasized its strategy to expand larger EBO stores (700+ sq. ft.) in Tier 2 and Tier 3 cities, aiming to nearly double retail area over five years. Product diversification, with non-leggings items contributing ~70% of revenue, and a strong supply chain with 168 suppliers were highlighted. The company also noted a 11.5% RoE and 8.9% RoCE in FY26, with cash reserves at Rs. 202 crores. The presentation included historical financials showing revenue growth from Rs. 401 crores in FY22 to Rs. 838 crores in FY26, though FY22 figures were impacted by lockdowns. The company's focus on expanding its retail network, leveraging technology, and strengthening its online presence were outlined as key growth strategies.

**tone_note**

The presentation provides factual financial data and strategic initiatives without overtly positive or negative language.
...
| tone_label valid (closed set) | ✅ |
| tone_label agrees | ✅ yes |
| Lexical overlap | 0.2752 _(triage aid, NOT a score)_ |
| Output shape | ✅ guided decoding — valid JSON by construction |
| Structured mode | `json_schema` |
| Latency | 54.9886 s |
| Input / output tokens | 9977 / 427 |
...
Unimech Aerospace and Manufacturing Limited reported strong financial performance in Q1 FY27, with revenue reaching ₹1,076.2 million, a 71% year-over-year increase, and EBITDA of ₹392.5 million, up 98% YoY. The company highlighted strategic acquisitions, including the Hobel Bellows acquisition completed in April 2026, and signed long-term agreements with key partners like FACC. Operational highlights included a 36.5% EBITDA margin, up 5% YoY, and a robust order book of ₹2,803 million as of June 30, 2026. Management emphasized expanding into aerospace, semiconductor, and energy sectors, with growing customer engagement and qualification-led growth initiatives. The presentation noted improved capacity utilization and confidence in FY27 growth driven by serial production transitions and sustained margin discipline. Financial metrics showed a 46% increase in PAT and a 46% rise in EPS. The company outlined strategic pillars focusing on global manufacturing expansion, technology investment, and diversification into high-growth sectors.

**tone_note**

The document emphasizes strong revenue and EBITDA growth, successful strategic acquisitions, and expanding market opportunities, reflecting a positive tone.
...
Rategain Travel Technologies Limited (RATEGAIN) reported strong financial performance in Q1 FY2027, with operating revenue growing 187.6% year-over-year to INR 785.0 crore. Adjusted EBITDA increased 289.3% to INR 193.4 crore (24.6% margin), and adjusted PAT rose 148.8% to INR 116.8 crore (14.9% margin). The company highlighted robust growth across diversified revenue streams, including subscription, transaction, and hybrid models, with 79.1% of revenue from subscription services. Revenue by industry type showed hospitality leading at 46.7%, followed by DMOs (33.5%) and OTAs (7.3%). Geographically, 66.2% of revenue came from North America, with 82.4% from top 1-10 customers. The company added 1,261 customers through the Sojern acquisition, bringing total customers to 14,158. Operational metrics included a 95.3% increase in revenue per employee, 47.3% higher employee count, and a 10.7x LTV to CAC ratio. Key innovations included Agentic ARI for hotel distribution, RateIQ for revenue recovery, and RG Pay for payments. Management emphasized disciplined growth, strong operating margins, and AI-driven product development as key drivers. The company also noted a 14.0% attrition rate and ongoing efforts to strengthen culture and employer branding.

**tone_note**

The document emphasizes strong financial growth, operational efficiency, and confidence in AI-driven innovation.
...
| tone_label valid (closed set) | ✅ |
| tone_label agrees | ✅ yes |
| Lexical overlap | 0.2067 _(triage aid, NOT a score)_ |
| Output shape | ✅ guided decoding — valid JSON by construction |
| Structured mode | `json_schema` |
| Latency | 41.7199 s |
| Input / output tokens | 8386 / 376 |
