...
| Cases | 20 of 20 |
| Run id | `20260830T041530Z` (2026-08-30T04:15:30.301837+00:00) |
...
| unguided | 0 |
| mean_latency_sec | 62.752 |
| total_prompt_tokens | 331214 |
| total_completion_tokens | 11328 |
| quality_verdict | NOT COMPUTED — requires human review, by design |
| tone_label_agreement_rate | 0.75 |
| invalid_tone_labels | 0 |
| tone_confusion | Mixed->Neutral=2, Positive->Positive=8, Neutral->Neutral=4, Mixed->Mixed=3, Positive->Mixed=2, Mixed->Positive=1 |
| mean_lexical_overlap | 0.2975 |
...
The investor presentation for Kanpur Plastipack Limited (KANPRPLA) for Q4 FY26 highlights the company's status as an integrated industrial packaging and technical textile manufacturer with a global presence across 60+ countries. The document outlines key financial results, showing a 26.98% year-over-year increase in total income to Rs. 73,132 lakh and a 42.11% rise in EBITDA to Rs. 7,770 lakh. The presentation emphasizes the company's core focus on FIBC (Flexible Intermediate Bulk Containers) as the primary growth driver, with 70% of revenue coming from exports, particularly in Europe. Strategic initiatives include the acquisition of Valex Ventures Ltd (UK), a joint venture with Essegomma S.p.A. (Italy), and expansion into technical textiles and non-woven fabrics. The company also details sustainability efforts, including solar energy usage and zero liquid discharge. The presentation notes the completion of a new FIBC manufacturing unit at Unit 3, Gajner Road, with 10% of its capacity already achieved ahead of schedule, and ongoing construction of a modern roll management system and a dedicated trading warehouse. The document also mentions the planned commencement of commercial production at the greenfield non-woven facility in September 2026, though this is not explicitly tied to financial results for the period. The company's financial snapshot shows improved margins across consolidated and standalone operations, with net profit rising significantly year-over-year. The presentation concludes with forward-looking strategies focused on diversification, premium product lines, and sustainability-driven growth.

**tone_note**

The presentation emphasizes growth in financial metrics, strategic expansions, and sustainability initiatives.
...
| tone_label valid (closed set) | ✅ |
| tone_label agrees | ✅ yes |
| Lexical overlap | 0.1893 _(triage aid, NOT a score)_ |
| Output shape | ✅ guided decoding — valid JSON by construction |
| Structured mode | `json_schema` |
| Latency | 69.8373 s |
| Input / output tokens | 23506 / 1434 |
| Tokens/sec (output) | 20.5 |
...
Som Distilleries & Breweries Limited reported a challenging FY26 with consolidated revenue declining 14.8% to INR1,233 crores and EBITDA at INR89.7 crores, driven by operational disruptions at the Bhopal facility and subdued demand in key markets like Karnataka and Odisha. Beer volumes fell 20% to 187.19 lakh cases, while IMFL business grew 32% to 15.03 lakh cases. Management highlighted ongoing efforts to resolve the Bhopal license issue and noted improved offtake trends in Karnataka post-excise duty rationalization. The company also mentioned the greenfield UP brewery project, with INR250 crores invested, is on track for commercial operations, which are anticipated to strengthen North India presence. Despite inflationary pressures on inputs, the company maintained a healthy balance sheet with a debt-to-equity ratio of 0.30x. For FY27, management guided toward revenue of INR1,400-1,500 crores, assuming Bhopal resumes operations and UP plant contributions. The company emphasized cost optimization and premiumization to mitigate margin pressures.

**tone_note**

The summary reflects both challenges faced in FY26 and cautious optimism for FY27 based on management's guidance.
...
| tone_label valid (closed set) | ✅ |
| tone_label agrees | ✅ yes |
| Lexical overlap | 0.2603 _(triage aid, NOT a score)_ |
| Output shape | ✅ guided decoding — valid JSON by construction |
| Structured mode | `json_schema` |
| Latency | 115.2444 s |
| Input / output tokens | 46014 / 1317 |
...
The investor presentation for Punjab National Bank (PNB) for Q1 FY2027 highlights strong financial performance, with net profit rising 213.6% YoY to ₹5,253 crore, driven by a 67 bps increase in ROA to 1.04% and a 17.2% YoY rise in operating profit. Business growth was robust, with global business up 10.2% YoY and domestic deposits growing 8.5% YoY. Asset quality improved, with gross NPA down 100 bps YoY to 2.78% and net NPA at 0.28%. Capital adequacy remained strong, with CRAR at 14.52%. Digital initiatives showed progress, including 365 lakh PNB One activated users and 357 crore digital transactions. ESG efforts included green financing and sustainability awards. Guidance for FY2027 included credit growth of 12-13% and deposit growth of 9-10%, though actuals for June 2026 showed deposit growth at 8.5%.

**tone_note**

The tone is mixed as the document highlights strong financial performance and digital progress but also notes that deposit growth fell short of the guidance for FY2027.
...
The investor presentation for Vedant Fashions Limited (MANYAVAR) outlines the company's financial performance and strategic initiatives for Q1 FY27. The document states that retail sales grew by 3.4% compared to Q1 FY26, with domestic same-store sales growth (SSSG) increasing by 3.8%. Revenue from operations rose by 7.2%, and the company maintained a strong gross margin of 65.7%. Profit after tax (PAT) increased by 14.7% year-over-year, with a PAT margin of 26.7%. The presentation highlights the company's extensive retail presence, including 501 EBOs across 205 cities, and its diversified brand portfolio catering to men, women, and children. Strategic initiatives include up-selling, cross-selling, and retail expansion both within and outside India. The document also mentions awards and accolades received by the company, including recognition for marketing campaigns and business performance. The company emphasizes its unique business model, technology-driven supply chain, and strong corporate governance. The presentation includes details on key financial metrics, brand campaigns, and future growth strategies.

**tone_note**

The tone is positive as the document highlights strong financial performance, growth in key metrics, and recognition through awards.
...
| tone_label valid (closed set) | ✅ |
| tone_label agrees | ✅ yes |
| Lexical overlap | 0.3277 _(triage aid, NOT a score)_ |
| Output shape | ✅ guided decoding — valid JSON by construction |
| Structured mode | `json_schema` |
| Latency | 59.745 s |
| Input / output tokens | 22387 / 904 |
...
Kiri Industries Limited reported Q1 FY27 results with a 63% year-on-year revenue growth to INR 295 crore on a standalone basis, driven by improved pricing in dyes, intermediates, and basic chemicals. Standalone EBITDA was INR 17 crore with a 5.86% margin, while consolidated revenue reached INR 312 crore with an EBITDA of INR 37 crore. Management highlighted progress on the integrated copper and fertilizer project, now in structured construction with capital from the company's strengthened financial position. Downstream copper facilities are planned for phased commissioning, with the copper tube plant to be operational in Q1 FY28 and the refinery by Q3 FY29, as management indicated. The company emphasized disciplined execution of projects and improving margins through pricing discipline and cost pass-through. Management addressed shareholder concerns about dividends, stating no current decision to declare them but emphasizing growth-focused capital allocation. Financial closure for the copper project remains ongoing, with over 50% of debt commitments secured. The company also discussed plans for value-added copper products and long-term sourcing agreements for raw materials, while noting challenges in achieving full capacity utilization in existing chemical operations. Management reiterated confidence in the long-term strategic roadmap and ongoing project timelines.

**tone_note**

The document emphasizes progress on key projects, improved financial performance, and confidence in future growth strategies.
...
- pass 4: forward-tense word 'expected'
...
| tone_label valid (closed set) | ✅ |
| tone_label agrees | ✅ yes |
| Lexical overlap | 0.2961 _(triage aid, NOT a score)_ |
| Output shape | ✅ guided decoding — valid JSON by construction |
| Structured mode | `json_schema` |
| Latency | 148.4182 s |
| Input / output tokens | 63280 / 1680 |
