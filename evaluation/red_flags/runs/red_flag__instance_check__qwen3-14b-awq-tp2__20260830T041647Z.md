...
| Sampling | temperature=0.0, max_tokens=512, seed=0 |
| Fixture | `/kaggle/input/datasets/ajaychouhan9/redixfi-llm-evaluation-2026/red_flag_benchmark.json` |
| Cases | 60 of 60 |
| Run id | `20260830T041647Z` (2026-08-30T04:16:47.490295+00:00) |
...
| unguided | 0 |
| mean_latency_sec | 1.285 |
| total_prompt_tokens | 60906 |
| total_completion_tokens | 1458 |
| quality_verdict | NOT COMPUTED — requires human review, by design |
| outcomes | false_negative=28, agree=12, agree_no_flag=19, false_positive=1 |
| agreement_rate | 0.5167 |
...
| Structured mode | `json_schema` |
| Latency | 0.9242 s |
| Input / output tokens | 1021 / 11 |
| Tokens/sec (output) | 11.9 |
...
The company has contingent liabilities, including performance bonds and other unspecified items, as of 31 March 2026 and 2025.
...
| Structured mode | `json_schema` |
| Latency | 2.1233 s |
| Input / output tokens | 1148 / 48 |
| Tokens/sec (output) | 22.6 |
...
The company is involved in a class action lawsuit under the Canadian Competition Act, alleging a conspiracy to fix prices and allocate the market for generic drugs. The potential liability from this claim is uncertain, and no provision has been made in the financial statements.
...
The company reduced ₹1,068 crore from contingent liabilities after resolving disputes related to tax treatment of certain matters.
...
| Structured mode | `json_schema` |
| Latency | 1.727 s |
| Input / output tokens | 1032 / 40 |
| Tokens/sec (output) | 23.2 |
...
The company has pending appeals against tax disallowances for the years 2018-19 and 2020-21, but no contingent liability has been reported as no demand was raised by the AO. The Service Tax Department issued demand notices for service tax, interest, and penalty, but the company disputes the calculation.
...
| Structured mode | `json_schema` |
| Latency | 2.9749 s |
| Input / output tokens | 1041 / 86 |
| Tokens/sec (output) | 28.9 |
...
The company has contingent liabilities related to certain litigations, including land compensation, direct and indirect taxes, and various claims filed by other parties not acknowledged as debt. The assessment of these contingent liabilities involves significant judgment and is supported by the company's judgment, past experience, and advice from legal and tax consultants.
...
| Structured mode | `json_schema` |
| Latency | 2.6493 s |
| Input / output tokens | 961 / 78 |
| Tokens/sec (output) | 29.4 |
...
The Audit Committee approved all related party transactions in accordance with the Company’s RPT Policy, with most transactions occurring between the Company and its subsidiaries/associates. The transactions were conducted at arm’s length and approved by independent directors.
...
The company has related party transactions with VGIPL, including purchase of goods, capital goods, sale of finished goods, and reimbursement of expenses, occurring during the financial year 2025-26.
...
The company's members approved an ordinary resolution regarding material related party transactions of its subsidiaries through a postal ballot.
...
| Structured mode | `json_schema` |
| Latency | 1.7569 s |
| Input / output tokens | 1141 / 35 |
| Tokens/sec (output) | 19.9 |
...
The company has pledged 51% of the total paid-up equity share capital and obtained a non-disposal undertaking from the sponsor for the balance 49% shareholding held by Adani Energy Holdings Limited.
...
| Structured mode | `json_schema` |
| Latency | 1.2132 s |
| Input / output tokens | 1223 / 11 |
| Tokens/sec (output) | 9.1 |
...
The company has pledged 13,17,12,154 fully paid up equity shares of Jindal Paradip Port Limited (JPPL) as security for debt facilities of C 2,854.43 crore sanctioned by lenders of JPPL.
...
| Structured mode | `json_schema` |
| Latency | 1.8029 s |
| Input / output tokens | 1086 / 40 |
| Tokens/sec (output) | 22.2 |
...
The company has pledged shares held in HZL as collateral for a loan, with a minimum coverage of 1.10 times the loan amount and a 50.1% non-dilution undertaking on HZL shares.
...
| Structured mode | `json_schema` |
| Latency | 2.4991 s |
| Input / output tokens | 1116 / 64 |
| Tokens/sec (output) | 25.6 |
...
The company is involved in pending legal proceedings and has executed a bond for customs duty and IGST liabilities, which may crystallize upon removal of goods from the bonded warehouse.
...
| Structured mode | `json_schema` |
| Latency | 2.1993 s |
| Input / output tokens | 968 / 61 |
| Tokens/sec (output) | 27.7 |
